...
\makeatother
\renewcommand{\thesection}{F.\arabic{section}}%Change to correct appendix nr
...
%see uml-book page 660.
%introduction and position
\include{parts/introduction}
\include{parts/factors}
\include{parts/decisions}
\include{parts/logical}
\include{parts/process}
\include{parts/use-case}
