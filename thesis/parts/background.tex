...
against scheduled times. Figure .~\vref{fig:kjoretidstes-strekning} is a density plot
...
\vref{fig:krysningsinteraksjon} plots the interaction between two trains
