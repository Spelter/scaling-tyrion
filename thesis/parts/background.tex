...
\vref{fig:cargonet}.
\begin{description}
	\item White arrow:\indent On time.
	\item Red arrow:\indent Delayed.
	\item Black box:\indent Locomotive without carriages.
	\item Yellow box:\indent Locomotive on time without schedule, or known position.
	\item Red box:\indent Locomotive driven 2km without carriages.
\end{description}
