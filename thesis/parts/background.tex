...
distance train the margin are 5 minutes and 59 seconds. 
Jernbaneverket (XXX see\vref{subsection:jernbaneverket}) defines regularity as the number of trains that gets run as 
