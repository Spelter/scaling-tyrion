...
\vref{fig:cargonet}.
\begin{itemize}
	\item [White arrow] On time.
	\item [Red arrow] Delayed.
	\item [Black box] Locomotive without carriages.
	\item [Yellow box] Locomotive on time without schedule, or known position.
	\item [Red box] Locomotive driven 2km without carriages.
\end{itemize}
