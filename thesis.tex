...
\input{abbriv}
\include{parts/background} % and state of the art
...
%\setcounter{page}{0}
%\pagenumbering{roman}
%\include{appendices/theory} %maybe we should find something useful to put here
% before we include it ^^

\addtocontents{toc}{\protect\setcounter{tocdepth}{0}}

\include{appendices/driver_interview}
\include{appendices/formula}
%\include{appendices/systemRequirements}
...
\begin{figure}[!htbp]
	\includegraphics[center]{glass_trolling.png}
	\caption*{Randall Munroe, "Glass Trolling", \url{http://xkcd/1304/} [Online; accessed 16. December 2013]}
	\label{fig:simple-hw}
\end{figure}
\end{document}
