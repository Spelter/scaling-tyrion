...
\usepackage[a4paper, layout=a4paper, textwidth=12cm,
bindingoffset=1cm,outer=2cm,inner=2cm,includefoot,bmargin=3cm]{geometry}
...
\makeatother
\renewcommand{\thesection}{E.\arabic{section}}%Change to correct appendix nr
