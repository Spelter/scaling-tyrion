...
Jernbaneverket is the Norwegian governments agency for railway services. As described in \Ref{sec:railway_operations}, 
...
The PRESIS (introduced in \Ref{sec:background_and_motivation}) aims is to systematically improve the precision level in the railway system by developing methods, tools, and processes. During the PRESIS project several prototypes for analyzing train delays have been developed.
